...
class ConvNet(nn.Module):
    def __init__(self, data_cfg, train_cfg):
        ...
        self.conv1 = nn.Conv2d(
            1, out_channels, kernel_size, padding=paddle, padding_mode=padding_mode
        )
...
class ComplexNet(nn.Module):
    def __init__(self, data_cfg, train_cfg):
        ...
        outdim1 = int(outdim1 / 2)
        outdim2 = int(outdim2 / 2)
        self.conv1r = nn.Conv2d(
            1, out_channels, kernel_size, padding=paddle, padding_mode='circular'
        )
        self.pool = nn.AvgPool2d((2, 2), stride=(2, 2))
